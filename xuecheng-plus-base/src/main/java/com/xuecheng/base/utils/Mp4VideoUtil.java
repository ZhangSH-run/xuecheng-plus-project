...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) throws IOException {
        //ffmpeg的路径
        String ffmpeg_path = "D:\\Tools\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
        //源mp4视频的路径
        String video_path = "C:\\Users\\ZSH\\Desktop\\V30317-122301.mp4";
        //转换后avi文件的名称
        String avi_name = "V30317-122301.avi";
        //转换后avi文件的路径
        String avi_path = "C:\\Users\\ZSH\\Desktop\\V30317-122301.avi";
        //创建工具类对象
        Mp4VideoUtil videoUtil = new Mp4VideoUtil(ffmpeg_path,video_path,avi_name,avi_path);
        //开始视频转换，成功将返回success
